          ...
          <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center bg-white rounded-lg p-3">
                <span className="text-gray-700">非緊急警察專線</span>
                <a href="tel:+358295480196" className="font-bold text-blue-600 hover:underline">
                  +358 29 548 0196
                </a>
              </div>
              <div className="flex justify-between items-center bg-white rounded-lg p-3">
              ...
              <div className="flex justify-between items-center bg-white rounded-lg p-3">
                ...
                <a href="tel:+18005474080" className="font-bold text-blue-600 hover:underline">
                  +1 800 547 4080
                </a>
              </div>
              <div className="flex justify-between items-center bg-white rounded-lg p-3">
                <span className="text-gray-700">信用卡掛失（Mastercard）</span>
                <a href="tel:+18003077309" className="font-bold text-blue-600 hover:underline">
                  +1 800 307 7309
                </a>
              </div>
            </div>
