...
const TaxRefundDrawer = ({ isOpen, onClose }: TaxRefundDrawerProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed z-50 bg-gradient-to-br from-amber-50 to-yellow-50 shadow-2xl
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-amber-200">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                  <p className="text-gray-700">
                    一般商品可退 <span className="text-xl font-bold text-amber-600">10-15%</span> 的增值稅 (VAT)
                  </p>
                  <p className="text-sm text-gray-600 mt-2">
                    *實際退稅金額會扣除手續費，約退回 8-12%
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="relative pl-12">
                ...
                <div className="bg-amber-50 rounded-lg p-5 border-l-4 border-amber-500">
                  ...
                  <p className="text-sm text-gray-700 mb-3">
                    持蓋章後的退稅單到退稅櫃檯（Tax Refund Counter）領取退款。可選擇現金、信用卡退款或支付寶。
                  </p>
                  <div className="bg-white rounded p-3 text-xs text-gray-600">
                    ...
                    <p>• <span className="font-bold">支付寶</span>：約 10 天入帳（需事先綁定）</p>
                  </div>
                </div>
              </div>
            </div>
